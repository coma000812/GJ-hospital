...
print('Connecting...')
vehicle = connect('udp:127.0.0.1:14551') #- NameError: name 'connect' is not defined??
...
while True:
    ...
    if mode == 'GROUND':
        ...
        n_WP, missionList = get_current_mission(vehicle) #- AttributeError'str'object has no attribute 'commands'??
